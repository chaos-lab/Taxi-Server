...
app.post '/driver/signin', (req, res) ->
  # TODO : password should be hashed
  if req.json_data.phone_number && req.json_data.password && drivers[req.json_data.phone_number].password == req.json_data.password
    req.session.user = { phone_number: req.json_data.phone_number, type: "driver" }
...
app.post '/passenger/signin', (req, res) ->
  # TODO : password should be hashed
  if req.json_data.phone_number && req.json_data.password && passengers[req.json_data.phone_number].password == req.json_data.password
    req.session.user = { phone_number: req.json_data.phone_number, type: "passenger"}
    ...
    res.json { status: 0, self: self, message: "welcome, #{passengers[req.json_data.phone_number].nickname}" }
  else
    res.json { status: 1 }
